...
namespace NSMB.Utils {
    public static class NetworkUtils {
        ...
        private readonly static Hashtable _defaultRoomProperties = new() {
            ...
            [Enums.NetRoomProperties.MushroomPowerup] = true,
            [Enums.NetRoomProperties.FirePowerup] = true,
            [Enums.NetRoomProperties.BlueShellPowerup] = true,
            ...
            [Enums.NetRoomProperties.MagmaPowerup] = true,
            [Enums.NetRoomProperties.MegaPowerup] = true,
            [Enums.NetRoomProperties.StarPowerup] = true,
