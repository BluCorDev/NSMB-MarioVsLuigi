...
public enum SoundEffect : byte {
    //CURRENT HIGHEST NUMBER: 117 (use 118 next)
    //Enemy
    ...
    [SoundEffectData("character/{char}/victory")] Player_Voice_Victory = 116,
    [SoundEffectData("character/{char}/nocontest")] Player_Voice_NoContest = 117,
